...
interface Sevasangraha2PrescriptionProps {
  patient: PatientWithRelations;
  onClose: () => void;
}

const Sevasangraha2Prescription: React.FC<Sevasangraha2PrescriptionProps> = ({ patient, onClose }) => {
  ...
  const handlePrint = () => {
    ...
    const printContent = `
      ...
      <html>
        <head>
          <title>Sevasangraha 2 Prescription - Print</title>
          <style>
            * {
              margin: 0;
              padding: 0;
  ...
  useEffect(() => {
    const fetchDepartmentDetails = async () => {
      console.log('🚀 Sevasangraha2 fetchDepartmentDetails called');
      console.log('🏥 Patient assigned_department:', patient.assigned_department);
      
      if (patient.assigned_department) {
        try {
          console.log('🔍 Sevasangraha2 Searching for department:', patient.assigned_department);
          ...
          console.log('📋 Sevasangraha2 Department query result:', departments);
          console.log('📋 Sevasangraha2 Query error:', error);
          
          if (departments && departments.length > 0) {
            const department = departments[0];
            console.log('✅ Sevasangraha2 Found department data:', department);
            ...
            console.log('🔍 Sevasangraha2 Trying alternative spelling:', searchTerm);
            ...
            console.log('📋 Sevasangraha2 Alternative spelling result:', altDepts);
            ...
            if (altDepts && altDepts.length > 0) {
              ...
              console.log('✅ Sevasangraha2 Found with alternative spelling:', department);
            } else {
              ...
              console.log('📋 Sevasangraha2 Partial match result:', partialDepts);
              ...
              if (partialDepts && partialDepts.length > 0) {
                ...
                console.log('✅ Sevasangraha2 Found partial match:', department);
              }
            }
          }
          
        } catch (error) {
          console.error('❌ Sevasangraha2 Database error:', error);
        }
      }
    };
    ...
    const loadPatientRecordData = async () => {
      try {
        ...
        if (savedPatientRecord) {
          console.log('✅ Sevasangraha2 Found Complete Patient Record data in database:', savedPatientRecord);
          
          // Map Complete Patient Record data to Sevasangraha2 prescription format
          ...
          toast.success('✅ Sevasangraha2: Loaded data from Complete Patient Record database!');
          console.log('✅ Sevasangraha2: Successfully mapped Complete Patient Record database to prescription format');
        } else {
          console.log('ℹ️ Sevasangraha2: No Complete Patient Record found for patient:', patient.patient_id);
        }
        
      } catch (error) {
        console.error('❌ Sevasangraha2: Error loading Complete Patient Record:', error);
        toast.error('Sevasangraha2: Error loading Complete Patient Record data');
      }
    };
...
export default Sevasangraha2Prescription;